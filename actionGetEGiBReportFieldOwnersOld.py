                                    ...
                                    for ownership_feature in ownership_layer.getFeatures(
                                        ...
                                        if ownership_single != NULL:
                                            ...
                                            if len(project.mapLayersByName("EGB_OsobaFizyczna")) == 0:
                                                showMessage('Właściciele działki ewidencyjnej', 'Do projektu nie została wczytana warstwa EGB_OsobaFizyczna')
                                            else:
                                                ...
                                                for owner_feature in owner_layer.getFeatures("gml_id IN(%s)" % owner_ids):
                                                    ...
                                                    town = ''
                                                    postal_code = ''
                                                    if len(project.mapLayersByName("EGB_Adres")) > 0:
                                                        address_layer = project.mapLayersByName("EGB_Adres")[0]
                                                        try:
                                                            addresses_ids = owner_feature.attribute("adresOsobyFizycznej")
                                                            addresses_ids = '' if addresses_ids == NULL else "'%s'" % addresses_ids.replace(", ", "', '")
                                                            for address_feature in address_layer.getFeatures("gml_id IN(%s)" % addresses_ids):
                                                                try:
                                                                    street = address_feature.attribute('ulica')
                                                                except:
                                                                    street = ''
                                                                try:
                                                                    number = address_feature.attribute(
                                                                        "numerPorzadkowy")
                                                                    local_number = address_feature.attribute(
                                                                        "nrLokalu")
                                                                ...
                                                                try:
                                                                    ...
                                                                    postal_code = ''
                                                                ownerships.append((owner, ownership_share, street,
                                                                                   number, postal_code, town))
                                                                street = ''
                                                                number = ''
                                                                town = ''
                                                                postal_code = ''
                                                            ...
                                                            town = ''
                                                            postal_code = ''
                                                            ownerships.append((owner, ownership_share, street, number,
                                                                               postal_code, town))
                                                    else:
                                                        ownerships.append(
                                                            (owner, ownership_share, street, number, postal_code, town))
                                        elif ownership_marriage != NULL:
                                            owner_ids = ownership_marriage
                                            owner_ids = '' if owner_ids == NULL else "'%s'" % owner_ids.replace(", ", "', '")
                                            if len(project.mapLayersByName("EGB_Malzenstwo")) == 0:
                                                showMessage('Właściciele działki ewidencyjnej', 'Do projektu nie została wczytana warstwa EGB_Malzenstwo')
                                            else:
                                                    ...
                                                    if len(project.mapLayersByName("EGB_OsobaFizyczna")) == 0:
                                                        ...
                                                        for owner_sub_feature in owner_sub_layer.getFeatures(
                                                            ...
                                                            if len(project.mapLayersByName("EGB_Adres")) > 0:
                                                                address_layer = project.mapLayersByName("EGB_Adres")[0]
                                                                try:
                                                                    addresses_ids = owner_sub_feature.attribute(
                                                                        "adresOsobyFizycznej")
                                                                    addresses_ids = '' if addresses_ids == NULL else "'%s'" % addresses_ids.replace(
                                                                        ", ", "', '")
                                                                    for address_feature in address_layer.getFeatures(
                                                                            "gml_id IN(%s)" % addresses_ids):
                                                                        try:
                                                                            street = address_feature.attribute('ulica')
                                                                        except:
                                                                            street = ''
                                                                        try:
                                                                            ...
                                                                            number = ''
                                                                        try:
                                                                            town = address_feature.attribute(
                                                                                'miejscowosc')
                                                                        except:
                                                                            town = ''
                                                                        try:
                                                                            postal_code = address_feature.attribute(
                                                                                'kodPocztowy')
                                                                        except:
                                                                            postal_code = ''
                                                                except:
                                                                    pass
                                                        ownerships.append(
                                                                    (owners, ownership_share, street, number, postal_code,
                                                                    town))
                                        elif ownership_institution != NULL:
                                            owner_ids = ownership_institution
                                            owner_ids = '' if owner_ids == NULL else "'%s'" % owner_ids.replace(", ", "', '")
                                            if len(project.mapLayersByName("EGB_Instytucja")) == 0:
                                                showMessage('Właściciele działki ewidencyjnej', 'Do projektu nie została wczytana warstwa EGB_Instytucja')
                                            else:
                                                ...
                                                for owner_feature in owner_layer.getFeatures("gml_id IN(%s)" % owner_ids):
                                                    ...
                                                    if len(project.mapLayersByName("EGB_Adres")) > 0:
                                                        address_layer = project.mapLayersByName("EGB_Adres")[0]
                                                        try:
                                                            addresses_ids = owner_feature.attribute(
                                                                "adresInstytucji")
                                                            addresses_ids = '' if addresses_ids == NULL else "'%s'" % addresses_ids.replace(
                                                                ", ", "', '")
                                                            for address_feature in address_layer.getFeatures(
