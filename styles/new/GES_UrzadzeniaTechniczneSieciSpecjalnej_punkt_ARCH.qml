...
<qgis styleCategories="Symbology|Labeling" version="3.22.4-Białowieża" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{e5a07ced-09ea-4c25-afa8-5c2ada06c99f}">
      <rule filter=" &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL" scalemindenom="1" scalemaxdenom="1001" key="{b8bdf2ca-8c8d-4280-9051-25dc39628cab}" description="Prezentacja graficzna">
