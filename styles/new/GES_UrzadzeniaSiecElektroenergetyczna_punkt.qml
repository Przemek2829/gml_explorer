...
<qgis styleCategories="Symbology|Labeling" version="3.22.4-Białowieża" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{cb5e162a-3ff2-4870-b3f3-0ea637c516c3}">
      <rule symbol="0" filter=" &quot;rodzajUrzadzenia&quot; = 'u'" scalemindenom="1" scalemaxdenom="1001" label="elektroenergetyczne urządzenie techniczne SUEU" key="{eadd3dd0-8207-40e9-b01e-89f071e17e4a}"/>
      <rule symbol="1" filter=" &quot;rodzajUrzadzenia&quot; = 's'" scalemindenom="1" scalemaxdenom="1001" label="szafa elektroenergetyczna lub kontener SUES" key="{3225bc32-fe30-444e-8be8-b2701e808a73}"/>
      <rule symbol="2" filter=" &quot;rodzajUrzadzenia&quot; = 't'" scalemindenom="1" scalemaxdenom="1001" label="stacja transformatorowa SUET" key="{dd43de04-00ff-4e7d-a389-2dd2ce571872}"/>
      <rule symbol="3" filter=" &quot;rodzajUrzadzenia&quot; = 'o'" scalemindenom="1" scalemaxdenom="1001" label="latarnia SUEO" key="{a7dc692c-615f-48cf-b3e4-ca903ec6af7f}"/>
      <rule symbol="4" filter=" &quot;rodzajUrzadzenia&quot; = 'm'" scalemindenom="1" scalemaxdenom="2001" label="maszt oświetleniowy SUEM" key="{b008ed1d-b245-4505-8084-f08e105e5854}"/>
      <rule symbol="5" filter=" &quot;rodzajUrzadzenia&quot; = 'a'" label="turbina wiatrowa SUEA" key="{f16ed4ce-bd1b-434e-be4b-b95516a4173a}"/>
      <rule symbol="6" filter=" &quot;rodzajUrzadzenia&quot; = 'l'" scalemindenom="1" scalemaxdenom="1001" label="stacja ładowania pojazdów elektrycznych SUEL" key="{83dbb426-5544-49e3-aa53-ca0f815978d2}"/>
    </rules>
    <symbols>
        ...
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          ...
          <effect type="effectStack" enabled="1">
            ...
            <effect type="color">
              ...
              <prop v="0" k="blend_mode"/>
              <prop v="235" k="brightness"/>
              <prop v="1" k="colorize"/>
              <prop v="255,0,0,255" k="colorize_color"/>
      ...
      <symbol type="marker" alpha="1" name="5" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          ...
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="C:/Users/wizipisi/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/gml_explorer/symbols/Turbina_SUEA.svg" k="name"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
      ...
      <symbol type="marker" alpha="1" name="6" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{87a40866-6427-402d-8621-53f29bf3812d}">
      <rule filter=" &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL" scalemindenom="1" scalemaxdenom="5001" key="{aa0638e0-04a4-4db8-8e92-82b4cb46e2ca}" description="Prezentacja graficzna">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" namedStyle="Normal" fontWordSpacing="0" isExpression="1" fontLetterSpacing="0" textOrientation="horizontal" multilineHeight="1" allowHtml="0" fieldName="IF(&quot;status&quot; = 'p', 'proj. e', IF( &quot;rodzajUrzadzenia&quot; IN('u', 's'), 'e', IF(&quot;rodzajUrzadzenia&quot; = 't', 'Tr', IF(&quot;rodzajUrzadzenia&quot; = 'l', 'E', ''))))" textColor="255,0,0,255" textOpacity="1" fontSize="0.75" useSubstitutions="0" legendString="Aa" capitalization="0" fontItalic="0" fontKerning="1" fontUnderline="0" blendMode="0" fontSizeUnit="RenderMetersInMapUnits" fontStrikeout="0" fontWeight="50" previewBkgrdColor="255,255,255,255">
            <families/>
          ...
          <placement lineAnchorType="0" distUnits="MM" lineAnchorPercent="0.5" offsetType="0" overrunDistance="0" geometryGeneratorEnabled="1" priority="5" repeatDistance="0" yOffset="0" rotationAngle="0" xOffset="0" preserveRotation="1" geometryGenerator=" geom_from_wkt(string_to_array( &quot;PrezentacjaGraficzna_geometria&quot; , ', ')[0])" offsetUnits="MM" placementFlags="10" polygonPlacementFlags="2" maxCurvedCharAngleOut="-25" geometryGeneratorType="PointGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" fitInPolygonOnly="0" placement="1" dist="0" repeatDistanceUnits="MM" quadOffset="4" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" layerType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleRadians" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" maxCurvedCharAngleIn="25" centroidInside="0"/>
