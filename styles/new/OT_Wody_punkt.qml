...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|Actions" version="3.22.4-Białowieża">
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{e835d90e-5ff0-4731-9dc9-af18dbb9e313}">
      <rule filter=" &quot;rodzajObiektu&quot; = 'i'" scalemindenom="1" key="{8defc702-1ebc-4513-bc55-49daf727391a}" symbol="0" label="inny obiekt związany z wodą OTWI" scalemaxdenom="1001"/>
    </rules>
    <symbols>
