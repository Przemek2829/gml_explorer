...
<qgis styleCategories="Symbology|Labeling" version="3.22.4-Białowieża" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{63962e92-24de-427c-8931-2d91e48dc1e8}">
      <rule filter=" &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL" scalemindenom="1" scalemaxdenom="1001" key="{0d1198b5-26fa-4809-a8ec-47c27187224d}" description="Prezentacja graficzna">
