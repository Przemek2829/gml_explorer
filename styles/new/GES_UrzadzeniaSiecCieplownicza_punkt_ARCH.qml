...
<qgis styleCategories="Symbology|Labeling" version="3.22.4-Białowieża" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{ad7f7026-ca02-4582-aa05-6074f7d07ed0}">
      <rule filter=" &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL" scalemindenom="1" scalemaxdenom="1001" key="{248263f4-feb2-4f19-8f11-622af0165ee7}" description="Prezentacja graficzna">
