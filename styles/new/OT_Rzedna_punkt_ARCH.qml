...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|Actions" version="3.22.4-Białowieża">
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{aec55ae0-ed6b-4de5-8b57-62403af7dc88}">
      <rule filter=" &quot;rodzajRzednej&quot; = 's'" scalemindenom="1" key="{686b1963-bf54-4d6e-8745-bb72f9063af0}" symbol="0" label="pikieta sztuczna OTRS" scalemaxdenom="1001"/>
      <rule filter=" &quot;rodzajRzednej&quot; = 'n'" scalemindenom="1" key="{717659ad-78d1-48ad-9260-b4402908a23a}" symbol="1" label="pikieta naturalna OTRN" scalemaxdenom="1001"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{edce216f-f560-4d0e-b212-0d67772bcc9f}">
      <rule filter=" &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL" scalemindenom="1" key="{c092c054-7a1b-4389-9824-d8dc775af525}" description="Prezentacja graficzna" scalemaxdenom="1001">
        <settings calloutType="simple">
          <text-style isExpression="0" textOpacity="1" textOrientation="horizontal" fontStrikeout="0" fontSize="0.75" capitalization="0" namedStyle="Normal" fontUnderline="0" fieldName="rzedna" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" blendMode="0" fontSizeUnit="RenderMetersInMapUnits" textColor="125,125,125,255" multilineHeight="1" fontItalic="0" fontWeight="50" fontKerning="1" allowHtml="0" legendString="Aa" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0">
            <families/>
