...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling|Actions" version="3.22.4-Białowieża">
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{5a71896f-dbb8-4a5c-95c6-b2ed99ce03fa}">
      <rule filter="COALESCE(&quot;status&quot;, 'i') = 'i' AND &quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL))" key="{63f3a076-15f8-472c-9072-e09bd67ff6f5}" symbol="0" label="budynek naziemny OTBU"/>
      <rule filter="COALESCE(&quot;status&quot;, 'i') = 'i' AND &quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL)" key="{da631318-ed1c-43f8-8196-d188b4845a28}" symbol="1" label="budynek podziemny OTBU"/>
      <rule filter="&quot;status&quot; = 'b'" key="{7275aa22-c987-456d-b40b-fb1a7ee63ede}" symbol="2" label="budynek w budowie OTBB"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="offset" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="IF(@map_scale &lt;= 500, 0.5, IF(@map_scale &lt;= 1000, 0.75, IF(@map_scale &lt;= 2000, 1.5, 3)))" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
  ...
  <labeling type="rule-based">
    <rules key="{b94f128b-9e88-4536-b93a-a889962dee9b}">
      ...
      <rule filter=" &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL AND &quot;status&quot; = 'i'" scalemindenom="1" key="{ccd6b372-829a-47e2-add3-354997348428}" description="Prezentacja graficzna" scalemaxdenom="1001">
        <settings calloutType="simple">
          <text-style isExpression="1" textOpacity="1" textOrientation="horizontal" fontStrikeout="0" fontSize="1" capitalization="0" namedStyle="Normal" fontUnderline="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" blendMode="0" fontSizeUnit="RenderMetersInMapUnits" textColor="0,0,0,255" multilineHeight="1" fontItalic="0" fontWeight="50" fontKerning="1" allowHtml="0" legendString="Aa" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0">
            <families/>
            <text-buffer bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferColor="255,255,255,255" bufferSize="0"/>
      ...
      <rule filter=" &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL AND &quot;status&quot; = 'i'" scalemindenom="1" key="{b5024beb-01ac-4bd1-abe2-753757e385cb}" description="Prezentacja graficzna" scalemaxdenom="1001">
        <settings calloutType="simple">
          <text-style isExpression="1" textOpacity="1" textOrientation="horizontal" fontStrikeout="0" fontSize="1" capitalization="0" namedStyle="Normal" fontUnderline="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" blendMode="0" fontSizeUnit="RenderMetersInMapUnits" textColor="0,0,0,255" multilineHeight="1" fontItalic="0" fontWeight="50" fontKerning="1" allowHtml="0" legendString="Aa" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0">
            <families/>
            <text-buffer bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferColor="255,255,255,255" bufferSize="0"/>
      ...
      <rule filter=" &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL AND &quot;status&quot; = 'i'" scalemindenom="1" key="{76b6f93f-1420-4639-9197-b9013397d4d1}" description="Prezentacja graficzna" scalemaxdenom="1001">
        <settings calloutType="simple">
          <text-style isExpression="1" textOpacity="1" textOrientation="horizontal" fontStrikeout="0" fontSize="1" capitalization="0" namedStyle="Normal" fontUnderline="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" blendMode="0" fontSizeUnit="RenderMetersInMapUnits" textColor="0,0,0,255" multilineHeight="1" fontItalic="0" fontWeight="50" fontKerning="1" allowHtml="0" legendString="Aa" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0">
            <families/>
            <text-buffer bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferColor="255,255,255,255" bufferSize="0"/>
      ...
      <rule filter=" &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL AND &quot;status&quot; = 'i'" scalemindenom="1" key="{2567599e-516c-4264-9941-b590a23328c6}" description="Prezentacja graficzna" scalemaxdenom="1001">
        <settings calloutType="simple">
          <text-style isExpression="1" textOpacity="1" textOrientation="horizontal" fontStrikeout="0" fontSize="1" capitalization="0" namedStyle="Normal" fontUnderline="0" fieldName="IF(&quot;liczbaKondygnacjiNadziemnych&quot; > 0 OR (&quot;liczbaKondygnacjiNadziemnych&quot; IS NULL AND (&quot;liczbaKondygnacjiPodziemnych&quot; = 0 OR &quot;liczbaKondygnacjiPodziemnych&quot; IS NULL)), concat(&quot;rodzajKST&quot;,  &quot;liczbaKondygnacjiNadziemnych&quot;), IF(&quot;liczbaKondygnacjiPodziemnych&quot; > 0 AND (&quot;liczbaKondygnacjiNadziemnych&quot; = 0 OR &quot;liczbaKondygnacjiNadziemnych&quot; IS NULL), concat(&quot;rodzajKST&quot;, '-',  &quot;liczbaKondygnacjiPodziemnych&quot;), ''))" fontWordSpacing="0" fontFamily="Arial" fontLetterSpacing="0" blendMode="0" fontSizeUnit="RenderMetersInMapUnits" textColor="0,0,0,255" multilineHeight="1" fontItalic="0" fontWeight="50" fontKerning="1" allowHtml="0" legendString="Aa" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0">
            <families/>
            <text-buffer bufferSizeUnits="RenderMetersInMapUnits" bufferNoFill="1" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferColor="255,255,255,255" bufferSize="0"/>
