...
<qgis styleCategories="Symbology|Labeling" version="3.22.4-Białowieża" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{4e22a2d8-e620-413c-a491-996f9e75eebf}">
      <rule filter=" &quot;PrezentacjaGraficzna_geometria&quot; IS NOT NULL" scalemindenom="1" scalemaxdenom="1001" key="{32a947c6-391b-46cb-9182-2087556b8848}" description="Prezentacja graficzna">
